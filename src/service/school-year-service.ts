...
import { SchoolYearRequest, SchoolYearResponse, toSchoolYearResponse } from "../model/school-year-model";
...
export class SchoolYearService {
    ...
    static async storeData(request: SchoolYearRequest): Promise<SchoolYearResponse>{
        const schoolYearRequest = Validation.validate(SchoolYearValidation.schoolYearRequest, request)
    ...
    static async updateDataById(request: SchoolYearRequest, schoolYearId: number): Promise<SchoolYearResponse>{
        const schoolYearRequest = Validation.validate(SchoolYearValidation.schoolYearRequest, request)
